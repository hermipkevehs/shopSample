            ...
            return (
               <article className="place-items-center grid group" key={index}>
                  <div className="relative overflow-hidden text-center">
                     ...
                     <div className="absolute top-100 h-full w-full transition group-hover:bg-gray-400 group-hover:duration-75 group-hover:top-60 group-hover:ease-in-out opacity-60 cursor-pointer">
